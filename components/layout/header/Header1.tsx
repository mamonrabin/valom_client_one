										...
										<div className="info-card-wrap">
											...
											<div className="info-card">
												...
												<div className="info-card_content">
													...
													<p className="info-card_link">Mirpur-1,Dhaka</p>
												</div>
											</div>
										</div>
									</nav>
									...
									<nav className="tgmenu__nav">
										...
										<div className="tgmenu__navbar-wrap tgmenu__main-menu d-none d-lg-flex">
											<ul className="navigation">
												...
												<li className=""><Link href="/service">Services</Link>
													{/* <ul className="sub-menu">
														<li><Link href="/service">Services</Link></li>
														<li><Link href="/service-details">Service Details</Link></li>
													</ul> */}
												</li>
												<li className=""><Link href="/project">Project</Link>
													{/* <ul className="sub-menu">
												...
												<li className=""><Link href="/blog-2">Blog</Link>
													{/* <ul className="sub-menu">
